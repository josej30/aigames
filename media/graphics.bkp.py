...
def drawPlane():
	...
	glVertex3f(-20.0, 0.0, 20.0)          # Top Left
	glVertex3f(20.0, 0.0, 20.0)           # Top Right
	glVertex3f(20.0, 0.0, -20.0)          # Bottom Right
	glVertex3f(-20.0, 0.0, -20.0)         # Bottom Left
	glEnd()                             # We are done with the polygon

def drawCube():
	global cubex, cubez, pressed
	...
	if pressed == "right":
        ...
        glTranslatef(cubex, 1.0, cubez);              # Set the cube over the plane
